            ...
            <div class="p-6">
                <div class="mb-8">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="{{ route('admin.blog.categories.index') }}"
                           class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition
                                  {{ request()->routeIs('admin.blog.categories.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        ...
                        <a href="{{ route('admin.blog.tags.index') }}"
                           class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition
                                  {{ request()->routeIs('admin.blog.tags.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                ...
                <div class="pt-6 border-t border-gray-200">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="{{ route('admin.ai-page-builder') }}"
                           class="flex items-center px-3 py-2 text-sm font-medium rounded-lg transition
                                  {{ request()->routeIs('admin.ai-page-builder') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            AI Page Builder
                            <span class="ml-auto text-[10px] font-semibold px-1.5 py-0.5 rounded bg-purple-100 text-purple-700">NEW</span>
                        </a>
