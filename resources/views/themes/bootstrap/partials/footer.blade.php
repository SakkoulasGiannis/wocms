            ...
            <div class="content-footer-top">
                <div class="footer-logo">
                    <a href="/">
                        ...
                        @else
                            <img src="/themes/bootstrap/images/logo/logo-footer@2x.png" alt="{{ $siteName }}" width="166" height="48">
                        @endif
                    </a>
                </div>
                <div class="wd-social">
                    ...
                    <ul class="list-social d-flex align-items-center">
                        ...
                        @endphp
                        <li>
                            <a href="{{ $socialFacebook }}" class="box-icon w-40 social">
                        ...
                        <li><a href="{{ $socialLinkedin }}" class="box-icon w-40 social">
                        ...
                        <li><a href="{{ $socialTwitter }}" class="box-icon w-40 social">
                        ...
                        <li><a href="{{ $socialPinterest }}" class="box-icon w-40 social">
                        ...
                        <li><a href="{{ $socialInstagram }}" class="box-icon w-40 social">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li><a href="{{ $socialYoutube }}" class="box-icon w-40 social">
            ...
            <div class="row">
                        ...
                        <ul class="mt-12">
                            @if($siteAddress)
                                <li class="mt-12 d-flex align-items-center gap-8">
                                    ...
                                    <p class="text-white">{{ $siteAddress }}</p>
                                </li>
                            @endif
                            @if($sitePhone)
                                <li class="mt-12 d-flex align-items-center gap-8">
                                    <i class="icon icon-phone2 fs-20 text-variant-2"></i>
                                    <a href="tel:{{ $sitePhone }}" class="text-white caption-1">{{ $sitePhone }}</a>
                                </li>
                            @endif
                            @if($siteEmail)
                                <li class="mt-12 d-flex align-items-center gap-8">
                                    <i class="icon icon-mail fs-20 text-variant-2"></i>
                                    <p class="text-white">{{ $siteEmail }}</p>
                                </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="footer-cl-2 footer-col-block">
                        ...
                        <div class="tf-collapse-content">
                            <ul class="mt-10 navigation-menu-footer">
                                @php
                                    $publicTemplates = \App\Models\Template::where('is_public', true)->limit(4)->get();
                                @endphp
                                @foreach($publicTemplates as $template)
                                    <li><a href="/{{ $template->slug }}" class="caption-1 text-variant-2">{{ $template->name }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="footer-cl-3 footer-col-block">
                        ...
                        <div class="tf-collapse-content">
                            <ul class="mt-10 navigation-menu-footer">
                                <li> <a href="/" class="caption-1 text-variant-2">Home</a> </li>
                                <li> <a href="/blog" class="caption-1 text-variant-2">Blog</a> </li>
                                @auth
                                    <li> <a href="/admin" class="caption-1 text-variant-2">Admin Panel</a> </li>
                                @else
                                    <li> <a href="/login" class="caption-1 text-variant-2">Login</a> </li>
                                @endauth
                            </ul>
                        </div>
    ...
    <div class="bottom-footer">
        <div class="container">
            <div class="content-footer-bottom">
                <div class="copyright">©{{ date('Y') }} {{ $siteName ?? 'CMS' }}. All Rights Reserved.</div>
