...
@section('content')
        ...
        <div class="flat-tab flat-tab-form">
            <div class="tab-content">
                <div class="tab-pane fade active show" role="tabpanel">
                    <div class="form-sl">
                        <form method="get" action="{{ route('rental-properties.index') }}">
    ...
    <section class="wrapper-layout layout-2" style="display:flex;gap:30px;position:relative;">
        <div class="wrap-left" style="flex:1;min-width:0;">
            {{-- Title + View Toggle --}}
            <div class="box-title-listing">
                ...
                <div class="box-filter-tab">
                    ...
                    <form method="get" action="{{ route('rental-properties.index') }}" class="d-inline">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active show" id="gridLayout" role="tabpanel">
                        <div class="row">
                            @forelse($properties as $property)
                                <div class="col-md-4">
                                    @include('frontend.rental-properties._card-grid', ['property' => $property])
                                </div>
                            @empty
                                <div class="col-12">
                    ...
                    <div class="tab-pane" id="listLayout" role="tabpanel">
                        <div class="row">
                            @forelse($properties as $property)
                                <div class="col-md-12">
                                    @include('frontend.rental-properties._card-list', ['property' => $property])
                                </div>
                            @empty
                                <div class="col-12">
                                    <div class="text-center py-12">
        ...
        {{-- Map --}}
        <div class="wrap-right" style="width:350px;flex-shrink:0;position:sticky;top:100px;align-self:flex-start;height:calc(100vh - 120px);">
            <div id="map" class="top-map" style="width:100%;height:100%;min-height:500px;background:#e8e8e8;border-radius:12px;overflow:hidden;"></div>
        </div>
    </section>
@endsection
...
<style>
    ...
    .wrapper-layout.layout-2 { max-width: 100%; overflow: hidden; }
    .wrapper-layout.layout-2 .wrap-left { position: static !important; }
    .wrapper-layout.layout-2 .wrap-right { position: sticky !important; }
    @media (max-width: 991px) {
        .wrapper-layout.layout-2 { flex-direction: column !important; }
        .wrapper-layout.layout-2 .wrap-right { width: 100% !important; position: relative !important; height: 400px !important; }
        .wrapper-layout.layout-2 .wrap-left .col-md-4 { flex: 0 0 50%; max-width: 50%; }
    }
    @media (max-width: 575px) {
        .wrapper-layout.layout-2 .wrap-left .col-md-4 { flex: 0 0 100%; max-width: 100%; }
    }
</style>
@endpush
    ...
    @php
        $mapData = $properties->getCollection()->map(function($p) {
            return [
                ...
                'url' => route('rental-properties.show', $p->slug),
