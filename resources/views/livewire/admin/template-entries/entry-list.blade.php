        ...
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('admin.templates.edit', $template->id) }}"
                   class="inline-flex items-center justify-center w-10 h-10 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition"
                   title="Edit {{ $template->name }} Template Settings">
