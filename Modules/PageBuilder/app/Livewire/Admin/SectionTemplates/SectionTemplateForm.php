...
namespace Modules\PageBuilder\Livewire\Admin\SectionTemplates;
...
class SectionTemplateForm extends Component
{
    ...
    public function mount($templateId = null): void
    {
    ...
    protected function syncFields(SectionTemplate $template): void
    {
    ...
    public function closeAddFieldModal(): void
    {
    ...
    {
        return view('pagebuilder::livewire.admin.section-templates.section-template-form')
