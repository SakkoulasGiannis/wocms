...
namespace Modules\PageBuilder\Livewire\Admin\ContentTree;
...
class SectionBuilder extends Component
{
    ...
    public function mount($nodeId = null): void
    {
        if ($nodeId) {
            $this->nodeId = $nodeId;
    ...
    public function loadNode($nodeId): void
    {
        $this->nodeId = $nodeId;
    ...
    public function toggleItem($itemKey): void
    {
    ...
    public function createSection($sectionTemplateId): void
    {
        $contentModel = $this->node->getContentModel();
    ...
    public function toggleSectionVisibility($sectionId): void
    {
        $section = PageSection::find($sectionId);
    ...
    public function updateItemContent($sectionId, $itemKey, $value): void
    {
        $section = PageSection::find($sectionId);
    ...
    {
        return view('pagebuilder::livewire.admin.content-tree.section-builder');
    }
}
