...
class PropertiesServiceProvider extends ServiceProvider
{
    ...
    {
        Livewire::component('properties.property-list', \Modules\Properties\Livewire\PropertyList::class);
        Livewire::component('properties.property-form', \Modules\Properties\Livewire\PropertyForm::class);
        Livewire::component('properties.crm-sync-dashboard', \Modules\Properties\Livewire\CrmSyncDashboard::class);
    }
    ...
    {
        $this->commands([
            \Modules\Properties\Console\SyncPropertiesCommand::class,
        ]);
    }
    ...
    protected function registerCommandSchedules(): void
    {
        $this->app->booted(function () {
            ...
            $schedule->command('properties:sync')->hourly();
        });
    }
